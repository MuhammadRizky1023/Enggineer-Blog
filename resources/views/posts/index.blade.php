...
<body>
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ url('post/create') }}" class="btn btn-success">Create New Post</a>
        </div>

        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <h1 class="fw-light">engineering blog</h1>
                    <p class="lead text-body-secondary">Everyone can create their own article blog about engginering.</p>
                    <div class="container mt-5">
                    <form class="mb-3">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a href="{{ url("post/{$post->slug}") }}" class="btn btn-sm btn-outline-secondary">View</a>
                                <a href="{{ url("post/{$post->slug}/edit") }}" class="btn btn-sm btn-outline-secondary">Edit</a>
                                <form method="POST" action="{{ route('post.destroy', $post->slug) }}" onsubmit="return confirm('Are you sure you want to delete this post?');">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-outline-secondary">Delete</button>
                                </form>
                             </div>
                            <small class="text-body-secondary">{{ date('d M Y H:i:s', strtotime($post->created_at)) }}</small>
                        </div>
                    </div>
                </div>
            </div>
